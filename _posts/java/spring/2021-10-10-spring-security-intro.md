---
layout: post
title:  "[spring] Spring Security 에 큰 그림"
comments: true
category: java
tags: spring
image: 
...
description: >
    Spring Security 에 대해서 알아보고 그 구성 요소에 대해서 학습한다.
sitemap: true
---
# 스프링 시큐리티의 큰 그림
...
![container](/assets/img/blog/java/spring/security/10-10/fig-1-servlet-container.png)
<!--more-->
...
![picture](/assets/img/blog/java/spring/security/10-10/fig-2-spring-big-picture.png)
...
![picture](/assets/img/blog/java/spring/security/10-10/fig-4-filters.png)
